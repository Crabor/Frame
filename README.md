...
| actuator_set   | actuator_name cmd arg1 ...  | true / false                                  | 设置actuator值<br/>true :设置actuator值成功<br/>false :设置actuator值失败<br/>注:arg参数可无                        |
...
| SensorMgr       | public Map<String, SensorInfo> getSupportedSensors();                            | {"api":"get_supported_sensors"}                                                              | [{"sensor_name":"xxxx","state":"on/off","value_type":"xxxx"},...]                  |
| SensorMgr       | public Map<String, SensorInfo> getRegisteredSensors();                           | {"api":"get_registered_sensors"}                                                             | [{"sensor_name":"xxxx","state":"on/off","value_type":"xxxx"},...]                  |
| SensorMgr       | public boolean getRegisteredSensorsStatus();                                     | {"api":"get_registered_sensors_status"}                                                      | {"state":true/false}                                                               |
| SensorMgr       | public boolean registerSensor(String sensorName, SensorModeType mode, int freq); | {"api":"register_sensor","sensor_name":"xxxx","mode":"xxxx","freq":xxxx}                     | {"state":true/false}                                                               |
| SensorMgr       | public boolean cancelSensor(String sensorName);                                  | {"api":"cancel_sensor","sensor_name":"xxxx"}                                                 | {"state":true/false}                                                               |
| SensorMgr       | public boolean cancelAllSensors();                                               | {"api":"cancel_all_sensors"}                                                                 | {"state":true/false}                                                               |
| SensorMgr       | public String getSensorData(String sensorName);                                  | {"api":"get_sensor_data","sensor_name":"xxxx"}                                               | {"default":"value"} / {"field1":"value1",...}                                      |
| SensorMgr       | public Map<String, String> getAllSensorData();                                   | {"api":"get_all_sensor_data"}                                                                | [{"sensor_name":"xxxx","value":{"default":"value"} / {"field1":"value1",...}},...] |
| SensorMgr       | public boolean getMsgThread(CmdType cmd);                                        | {"api":"get_msg_thread","cmd":"xxxx"}                                                        | {"state":true/false}                                                               |
| ActorMgr     | public Map<String, ActorInfo> getSupportedActors();                        | {"api":"get_supported_actuators"}                                                            | [{"actuator_name":"xxxx","state":"on/off","value_type":"xxxx"},...]                |
| ActorMgr     | public Map<String, ActorInfo> getRegisteredActors();                       | {"api":"get_registered_actuators"}                                                           | [{"actuator_name":"xxxx","state":"on/off","value_type":"xxxx"},...]                |
| ActorMgr     | public boolean getRegisteredActorStatus();                                    | {"api":"get_registered_actuators_status"}                                                    | {"state":true/false}                                                               |
| ActorMgr     | public boolean registerActor(String actuatorName);                            | {"api":"register_actuator","actuator_name":"xxxx"}                                           | {"state":true/false}                                                               |
| ActorMgr     | public boolean cancelActor(String actuatorName);                              | {"api":"cancel_actuator","actuator_name":"xxxx"}                                             | {"state":true/false}                                                               |
| ActorMgr     | public boolean cancelAllActors();                                             | {"api":"cancel_all_actuators"}                                                               | {"state":true/false}                                                               |
| ActorMgr     | public boolean setActorCmd(String actuatorName, String cmd, String ... args)  | {"api":"set_actuator","actuator_name":"xxxx","cmd_type":"xxxx","args":[{"arg":"xxxx"},...]}} | {"state":true/false}                                                               |
| AbstractApp     | public boolean isServerOn(ServiceType service);                                  | {"api":"is_service_on","service_type":"xxxx"}                                                | {"state":true/false}                                                               |
...
| AbstractApp     | public String call(ServiceType serviceType, CmdType cmdType, String... args);    | {"api":"service_call","service_type":"xxxx","cmd_type":"xxxx","config":"config_json"}        | {"ret":"xxxx"}                                                                     |
| ctx             | public boolean setRuleFile(String ruleFile);                                     | {"api":"set_rule_file","file_name":"xxxx","content":"xxxx"}                                  | {"state":true/false}                                                               |
| ctx             | public boolean setPatternFile(String patternFile);                               | {"api":"set_pattern_file","file_name":"xxxx","content":"xxxx"}                               | {"state":true/false}                                                               |
| ctx             | public boolean setBfuncFile(String bfuncFile);                                   | {"api":"set_bfunc_file","file_name":"xxxx","content":"xxxx"}                                 | {"state":true/false}                                                               |
| ctx             | public boolean setMfuncFile(String mfuncFile);                                   | {"api":"set_mfunc_file","file_name":"xxxx","content":"xxxx"}                                 | {"state":true/false}                                                               |
| ctx             | public boolean setRfuncFile(String rfuncFile);                                   | {"api":"set_rfunc_file","file_name":"xxxx","content":"xxxx"}                                 | {"state":true/false}                                                               |
| ctx             | public boolean setCtxValidator(String ctxValidator);                             | {"api":"set_ctx_validator","ctx_validator":"xxxx"}                                           | {"state":true/false}                                                               |
| inv(有比较多问题)     |                                                                                  |                                                                                              |                                                                                    |
|                 |                                                                                  |                                                                                              |                                                                                    |
|                 |                                                                                  |                                                                                              |                                                                                    |
