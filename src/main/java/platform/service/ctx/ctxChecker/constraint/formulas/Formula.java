...
public abstract class Formula {
    ...
    //S-condition
    public abstract void DeriveIncPlusSet(Set<Map.Entry<ContextChange.ChangeType, String>> incPlusSet);
    public abstract void DeriveIncMinusSet(Set<Map.Entry<ContextChange.ChangeType, String>> incMinusSet);
    //C-condition
