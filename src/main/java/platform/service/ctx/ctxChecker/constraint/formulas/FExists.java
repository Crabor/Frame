...
public class FExists extends Formula{
    ...
    public void DeriveIncPlusSet(Set<Map.Entry<ContextChange.ChangeType, String>> incPlusSet) {
        incPlusSet.add(new AbstractMap.SimpleEntry<>(ContextChange.ChangeType.DELETION, pattern_id));
    ...
    public void DeriveIncMinusSet(Set<Map.Entry<ContextChange.ChangeType, String>> incMinusSet) {
        incMinusSet.add(new AbstractMap.SimpleEntry<>(ContextChange.ChangeType.ADDITION, pattern_id));
