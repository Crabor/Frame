package platform.service.ctx.ctxChecker.Constraints;
...
public class Rule {
    ...
    private final Set<Map.Entry<ContextChange.ChangeType, String>> incPlusSet;
    private final Set<Map.Entry<ContextChange.ChangeType, String>> incMinusSet;
    //bath and Newbatch
    ...
    public String getIncType(ContextChange contextChange) {
        Map.Entry<ContextChange.ChangeType, String> entry= new AbstractMap.SimpleEntry<>(contextChange.getChangeType(), contextChange.getPatternId());
    ...
    public void addCriticalSet(Set<Link> links){
        ...
        for(Link link : links){
            for(Map.Entry<String, Context> entry : link.getVaSet()){
                this.criticalSet.add(entry.getValue().getContextId());
            }
        }
    }
    ...
    public Set<Map.Entry<ContextChange.ChangeType, String>> getIncMinusSet() {
        return incMinusSet;
    }

    public Set<Map.Entry<ContextChange.ChangeType, String>> getIncPlusSet() {
        return incPlusSet;
    }
